...
footer: 'Week 1 · Day 4 · Deploy (Windows · PowerShell)'
---
...
> Needs **PowerShell 7**: `scoop install pwsh`. `.\make.ps1 deploy-pa` re-launches itself under `pwsh` automatically if you started in Windows PowerShell 5.1.
...
`.\make.ps1 deploy-pa` is hands-off **except once**. It creates your web app, opens a **bash console** on PA, and stops:
